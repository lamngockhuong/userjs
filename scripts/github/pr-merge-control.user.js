...
(function () {
  ...
  function observeDOM() {
    ...
    if (targetBranch) {
      setTimeout(() => applyMainButtonRestriction(targetBranch), 500);
      setTimeout(() => applyMainButtonRestriction(targetBranch), 1500);
    }
  ...
  function init() {
    observeDOM();
    console.log('[PR Merge Control] v1.2 Initialized');
  }
